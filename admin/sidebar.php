<div class="sidebar">
			<div class="sidebar-container"> .
                ...
                <ul class="sidebar-menu scrollable pos-r ps ps--active-y">
                    ...
                    <li class="nav-item">
    						<a href="user.php" class="sidebar-link" href="#">
    							<span class="icon-holder">
    								<i class="c-brown-500 ti-user">
    								</i> 
    							</span>
                    ...
                    <li class="nav-item">
    						<a href="product.php" class="sidebar-link" href="#">
    							<span class="icon-holder">
    								<i class="c-brown-500 ti-shopping-cart-full">
    								</i> 
    							</span>
    					...
    					<li class="nav-item dropdown">
    						<a class="dropdown-toggle" onClick="drop-data-links">
    							<span class="icon-holder">
